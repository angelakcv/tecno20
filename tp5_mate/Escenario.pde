...
class Escenario {
  ...
  Escenario (float x_, float y_) {
    ...
    font1 = loadFont ("OldLondon-48.vlw");//no lo uso
    font2 = loadFont ("VCROSDMono-48.vlw");
    
     boton1 = new Boton ("INICIAR", /*font2,*/ width/2, height/2-40, 150, 50, 30);
  ...
  void draw () {
    ...
    if (estado.equals("menu")) {
      ...
      //título
      texto(font2, color(255), 80);
      text("¡Esquiva!", 200, 100);
    ...
    if (estado.equals("juego")) {
      ...
      noStroke();
      //cuadro texto
      recTexto(color(0), width/2, 400, width, 70);
